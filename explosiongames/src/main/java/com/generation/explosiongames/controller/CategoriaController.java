...
import com.generation.explosiongames.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	public ResponseEntity<List<CategoriaModel>> GetAll (){ // metodo que busca tudo de categoria
